...
include_once('WoocommerceAmazonDropshipping_InstallIndicator.php');

class WoocommerceAmazonDropshipping_LifeCycle extends WoocommerceAmazonDropshipping_InstallIndicator {
